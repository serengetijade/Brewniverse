...
import { ArrowLeft, ArrowDownUp, Bell, BookOpen, Calculator, FileText, Home, Menu, NotebookPen, Settings } from 'lucide-react';
...
function Navigation() {
    ...
    const menuItems = [
        ...
        { path: '/inventory', icon: ArrowDownUp, label: 'Inventory' },
