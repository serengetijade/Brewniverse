        ...
        <div className="alcohol-chart-container">
            ...
            <div className="alcohol-chart-stats">
                <div className="stat-item">
                    ...
                    <span className="stat-value">{alcoholData.currentAbv.toFixed(2)}%</span>
                </div>
                <div className="stat-item">
                    <span className="stat-label">Potential ABV</span>
                    <span className="stat-value">{alcoholData.potentialAbv.toFixed(2)}%</span>
                </div>
                <div className="stat-item">
                    <span className="stat-label">Remaining</span>
                    <span className="stat-value">{alcoholData.remainingAbv.toFixed(2)}%</span>
                </div>
            </div>
